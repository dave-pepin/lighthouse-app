...
// Mirrors app/client/set-password/page.js — same Supabase invite-link
// mechanic (session tokens land in the URL fragment, only the browser can
// read them) — but kept as its own page rather than reused, since the
// client version calls notifyClientActivated() and redirects into the
// client portal, neither of which apply to a newly-paid agent.
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: 13, color: "var(--lh-slate)", marginBottom: 20 }}>
          Set a password to get into your account.
        </p>

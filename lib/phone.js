...
export function formatUSPhoneInput(value) {
  ...
  // A pasted or typed number that includes the country code (11 digits,
  // leading 1) is still just a 10-digit US number underneath — strip the
  // 1 rather than slicing it off the end below, which would otherwise
  // silently drop the real last digit instead.

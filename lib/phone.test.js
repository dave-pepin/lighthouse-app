...
describe("formatUSPhoneInput", () => {
  ...
  it("strips a leading US country code instead of truncating the last digit", () => {
    expect(formatUSPhoneInput("17126355945")).toBe("(712) 635-5945");
    expect(formatUSPhoneInput("+1 712-635-5945")).toBe("(712) 635-5945");
  });
});
